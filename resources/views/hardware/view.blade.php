                        ...
                        <div class="info-stack-container">
                            ...
                            <div class="col-md-3 col-xs-12 col-sm-push-9 info-stack">
                                ...
                                <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                    ...
                                    <button type="submit" formtarget="_blank" class="btn btn-block btn-social btn-sm btn-default" id="bulkEdit"{{ (!$asset->model ? ' disabled' : '') }}{!! (!$asset->model ? ' data-tooltip="true" title="'.trans('admin/hardware/general.model_invalid').'"' : '') !!}>
                                        <x-icon type="assets" />
