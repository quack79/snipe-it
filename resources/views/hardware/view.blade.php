                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{ Form::open([
                                                ...
                                                <button type="submit" formtarget="_blank" class="btn btn-sm btn-default" id="bulkEdit" ><i class="fas fa-barcode" aria-hidden="true"></i> {{ trans_choice('button.generate_labels', 1) }}</button>
